DELETE FROM map_reports;
DELETE FROM visual_route_steps;
DELETE FROM visual_routes;
DELETE FROM poi_evaluations;
DELETE FROM pois;
DELETE FROM buildings;
DELETE FROM users;
-- 1. Inserindo Usuários
INSERT OR IGNORE INTO users (id, name, email, auth_provider, avatar_url, contribution_count) 
VALUES 
...
INSERT OR IGNORE INTO buildings (id, name, lat, lon, address, phone, email, website) 
VALUES 
...
INSERT OR IGNORE INTO pois (id, building_id, category, name, lat, lon, details_json, status, created_by) 
VALUES 
...
INSERT OR IGNORE INTO poi_evaluations (id, poi_id, user_id, is_pcd, had_difficulty, mobility_aid, description) 
VALUES 
...
INSERT OR IGNORE INTO visual_routes (id, destination_poi_id, origin_name, status, created_by)
VALUES
('route_001', 'poi_001', 'Portaria Principal', 'active', 'usr_001');

-- 6. Inserindo os Passos dessa Rota Visual
INSERT OR IGNORE INTO visual_route_steps (id, visual_route_id, step_order, description, image_url)
VALUES
...
INSERT OR IGNORE INTO map_reports (id, user_id, report_type, geom_type, lat, lon, geometry_json, image_url, details_json, status)
VALUES
